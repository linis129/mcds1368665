        ...
        <nav class="navbar navbar-inverse bg-inverse">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand opt-nav" href="{{ url('consulta_ambiente') }}"> Consulta Ambiente Formacion</a>
                    <a class="navbar-brand opt-nav" href="{{ url('consulta_instructor') }}"> Consulta Instructor</a>
                     @endif
                </div>
