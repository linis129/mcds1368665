...
@section('content')
  <div class="row">
    ...
    <div class="col-lg-10">
      ...
      <!-- Box Titulo -->
      <div class="title">
        <h2 class="text-center">Ambiente de Formacion</h2>
        <hr>
        <br>
      </div>
      ...
      <div class="col">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-center">
                ...
                <form action="{{url('gestion_ambiente/'.$row->id)}}" method="post" style="display: inline-block;">
        ...
        @else
            <h5 class="text-center">Sin Registros De Ambiente...</h5>
        @endif
      </div>
    ...
    <div id="modal-actualizar" class="modal fade" role="dialog">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h4 class="modal-title">Actualizar Datos Ambiente</h4>
          </div>
  ...
  <script>
    $(document).ready(function(){
      ...
      $('.editAmbiente').click(function(){

        var UUID = $(this).attr('data-UUID');
        console.log(UUID)
        $.get('http://localhost:8000/gestion_ambiente/editarAjax/'+UUID,
          function(data){
            $('#editar').html(data);
            console.log(data);
          });
